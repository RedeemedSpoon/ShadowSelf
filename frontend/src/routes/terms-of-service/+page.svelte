...
<div>
  ...
  <h3>Governing Law</h3>
  <p>
    These Terms of Service shall be governed by and construed in accordance with the laws of Switzerland, without regard to its
    conflict of law principles.
  </p>
  <h3>Entire Agreement</h3>
  <p>
    These Terms of Service constitute the entire agreement between you and Shadowself and supersede all prior or contemporaneous
    communications, representations, or agreements, whether oral or written, with respect to the Service.
  </p>
  <h3>Severability</h3>
  <p>
