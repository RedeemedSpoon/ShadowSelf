...
export {default as circuitPattern} from './circuit-pattern.svg';
export {default as satisfaction} from './satisfaction.png';
export {default as itCrowdGif} from './IT-Crowd.gif';

export {default as card} from './features/card.png';
export {default as wifi} from './features/wifi.png';
export {default as cloud} from './features/cloud.png';
export {default as email} from './features/email.png';
export {default as globe} from './features/globe.png';
export {default as money} from './features/money.png';
export {default as phone} from './features/phone.png';
