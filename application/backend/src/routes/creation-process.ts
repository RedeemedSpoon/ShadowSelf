...
export default new Elysia({ websocket: { idleTimeout: 300 } })
  ...
  .ws('/ws-creation-process', {
    ...
    async message(ws, message: CreationProcess | 'ping') {
      ...
      switch (message.kind) {
        // choose location/country of the identity
        case 'location': {
          ws.send({ locations });
          break;
        }

        // choose informatic metadata of the identity
        case 'profile': {
          if (message.location) {
        ...
        // choose email address of the identity 
        case 'email': {
        ...
        // choose phone number of the identity 
        case 'phone': {
        ...
        // choose crypto wallet seed of the identity 
        case 'wallet': {
        ...
        // create and store the actual identity 
        case 'provision': {
